...
Use `mean()` and `sd()` to find the mean and standard deviations for:
...
Explore at least **5** other variables that you think might have a relationship with maximizing and/or regret.
